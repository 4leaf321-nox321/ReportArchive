...
**도구 설명 비용**: 41개 합계 17,530자 ≈ 8,800 토큰/요청. 가장 긴 둘
(`update_report_draft` 1,574자 · `create_report_draft` 1,471자)은 **작성 규약 자체**라
줄이면 출력 품질이 떨어질 위험이 크다 — 손대지 않았다. 정말 줄여야 하면 파일 업로드
4종(2,790자)이 후보.
